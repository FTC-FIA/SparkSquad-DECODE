...
@Autonomous(name="Auton Driving Test - All w/ PID", group="Test")
public class Auton_DrivingTestPIDAll extends AutonBaseOpMode {
    ...
    public void init() {
        ...
        this.autonTaskList = new AutonTaskList(
            ...
            new Task[]{
                    ...
                    new MoveWithPIDTo(this, 24.0, 24.0, 45.0),
                    new Wait(this, 1.0),
                    new MoveWithPIDTo(this, 0.0, 24.0, 90.0),
                    new Wait(this, 1.0),
