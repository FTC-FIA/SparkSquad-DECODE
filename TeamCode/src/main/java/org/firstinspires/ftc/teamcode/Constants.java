...
public class Constants {
    ...
    public static final double DEFAULT_AUTON_FORWARD_POWER = 0.3;
    public static final double DEFAULT_AUTON_STRAFE_POWER = 0.3;
    ...
    public static AlliancePose2D S3 = new AlliancePose2D(20.0, 20.0, 45.0, Alliance.BLUE); // close
    ...
    public static AlliancePose2D IS3 = new AlliancePose2D(20.0, 12.0, 180.0, Alliance.BLUE); // PPG (closest 2 goal)
    ...
    public static AlliancePose2D IE3 = new AlliancePose2D(40.0, 12.0, 180.0, Alliance.BLUE); // PPG (closest 2 goal)
