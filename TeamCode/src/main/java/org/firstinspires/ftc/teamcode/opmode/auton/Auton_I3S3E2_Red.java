...
public class Auton_I3S3E2_Red extends RobotBaseOpMode {
    ...
    private Pose2D I3Red = new Pose2D(duInch, 40.0, -60.0, angDegrees, 0.0);
    private Pose2D S3Red = new Pose2D(duInch, 12.0, 12.0, angDegrees, -45.0);
    private Pose2D E2Red = new Pose2D(duInch, 0.0, 24.0, angDegrees, 0.0);

    private Pose2D I3 = I3Red;
    private Pose2D S3 = S3Red;
    private Pose2D E2 = E2Red;
